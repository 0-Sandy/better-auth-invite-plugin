...
export const createInviteBodySchema = z.object({
  ...
  redirectToSignUp: z
    .string()
    .describe("The URL to redirect the user to create their account. If the token isn't valid or expired, it'll be redirected with a query parameter `?error=INVALID_TOKEN`. If the token is valid, it'll be redirected with a query parameter `?token=VALID_TOKEN")
    .optional(),
  /**
